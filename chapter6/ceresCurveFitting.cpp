...
class AnalyticCurveFittingCostFunction : public ceres::SizedCostFunction<1, 3>
{
public:
...
int main(int argc, char **argv)
{
    ...
    for (int i = 0; i < N; i++)
    {
        ...
        problem_auto.AddResidualBlock(
            ...
            new ceres::AutoDiffCostFunction<AutoCurveFittingCostFunctor, 1, 3>(
    ...
    cout << "auto diff estimated a, b, c = ";
    for (auto a : abc_auto)
    {
        cout << a << " ";
    }
    ...
    cout << "analytic diff estimated a, b, c = ";
    for (auto a : abc_ana)
    {
        cout << a << " ";
    }
